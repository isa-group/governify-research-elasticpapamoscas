...
//						
						...
						Boolean nextLevel = availability < minAvailability + (governConfig.getRouterConfig().get("nextLevel") * (100 - minAvailability));
						Boolean backLevel = availability > minAvailability + (governConfig.getRouterConfig().get("backLevel") * (100 - minAvailability));
